...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-light dark:bg-dark rounded-base shadow-xs border border-default p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-heading dark:text-white">Create New Campaign</h1>
                <p class="text-body dark:text-neutral-400 mt-1">Fill in the details to start a new campaign</p>
            </div>
