        ...
        <div class="overflow-x-auto bg-white dark:bg-gray-800 shadow rounded-lg">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Name
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Email
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Role
                        </th>
                    ...
                    @foreach($contractors as $contractor)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <a href="{{ route('contractor-assignments.edit', $contractor) }}"
                                    class="text-blue-600 hover:text-blue-900 dark:text-blue-400">Edit Regions</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
