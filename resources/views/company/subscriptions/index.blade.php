                ...
                <tbody>
                    @forelse($subscriptions as $sub)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $sub->plan->price }} $</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $sub->end_date ? $sub->end_date->format('Y-m-d') : '-' }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4">No subscriptions yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
