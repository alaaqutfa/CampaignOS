...
<div class="max-w-2xl mx-auto">
    <div class="bg-light dark:bg-dark rounded-base shadow-xs border border-default p-6">
        <div class="mb-6">
            ...
            <p class="text-body dark:text-gray-400 mt-1">Update user details</p>
        </div>
        ...
        <form action="{{ route('super-admin.users.update', $user) }}" method="POST">
            ...
            <!-- Password (optional) -->
            <div class="mb-4">
                <label for="password" class="block text-sm font-medium text-heading dark:text-white mb-1">New Password (leave blank to keep current)</label>
            ...
            <div class="mb-4">
                <label for="password_confirmation" class="block text-sm font-medium text-heading dark:text-white mb-1">Confirm New Password</label>
