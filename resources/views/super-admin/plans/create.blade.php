...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-light dark:bg-dark rounded-base shadow-xs border border-default p-6">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-heading dark:text-white">Add New Plan</h1>
                <p class="text-body dark:text-gray-400 mt-1">Create a subscription plan for companies</p>
            </div>
